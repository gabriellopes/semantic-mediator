 ...
 */
public class MediatorConfigTest extends TestCase implements Config {

    private String _config_path = "..\\example\\mediator_config.xml";
    private String _root_path = "..\\example";

    private static MediatorConfigTest _instance = null;
    ...
    protected MediatorConfigTest() {
        initConfig();
    }

    //Singleton
    public static MediatorConfigTest getInstance() {
        if (_instance == null) {
            _instance = new MediatorConfigTest();
        }
        return _instance;
    }
